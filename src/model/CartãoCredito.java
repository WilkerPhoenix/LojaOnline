...
public class CartãoCredito extends JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Pagamento Cartão de Crédito");
        ...
        jLabel2.setText("Número do Cartão de Crédito");
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(CartãoCredito.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }

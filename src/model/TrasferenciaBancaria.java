...
public class TrasferenciaBancaria extends JFrame {
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(TrasferenciaBancaria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
